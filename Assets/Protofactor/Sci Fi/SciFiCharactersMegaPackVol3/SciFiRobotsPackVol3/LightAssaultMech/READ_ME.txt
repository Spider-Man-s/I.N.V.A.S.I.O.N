...
We developed the Light Melee Mech in such a way that it doesn't have any death animation. Instead we decided to provide a split into pieces version of the mech in its idle active pose.
...
As an example, you can use a script like this (Make sure to attach the Script to the root Game Object: "LightAssaultMechExploded_xxxxx" prefab):
